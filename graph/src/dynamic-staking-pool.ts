...
import {
	NewProfit as NewProfitEvent,
	ProfitDistribution as ProfitDistributionEvent,
} from "../generated/templates/DynamicStakingPool/DynamicStakingPool";
...
export function handleProfitDistribution(event: ProfitDistributionEvent): void {
	...
	profit.totalStaked = DynamicStaking.bind(
