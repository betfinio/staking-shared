...
import {
	NewClaimable as NewClaimableEvent,
	ProfitDistribution as ProfitDistributionEvent,
} from "../generated/templates/ConservativeStakingPool/ConservativeStakingPool";
...
export function handleProfitDistribution(event: ProfitDistributionEvent): void {
	...
	const profit = new ProfitDistribution(
	...
	profit.totalStaked = ConservativeStaking.bind(
		Address.fromBytes(staking),
	).totalStaked();
